...
TEST(Decimal128Test, TestAsin) {
    ...
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.9").asin(), Decimal128("-1.119769515"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.8").asin(), Decimal128("-0.927295218002"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.7").asin(), Decimal128("-0.775397496611"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.6").asin(), Decimal128("-0.643501108793"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.5").asin(), Decimal128("-0.523598775598"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.4").asin(), Decimal128("-0.411516846067"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.3").asin(), Decimal128("-0.304692654015"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.2").asin(), Decimal128("-0.20135792079"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.1").asin(), Decimal128("-0.100167421162"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.0").asin(), Decimal128("0.0"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.1").asin(), Decimal128("0.100167421162"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.2").asin(), Decimal128("0.20135792079"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.3").asin(), Decimal128("0.304692654015"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.4").asin(), Decimal128("0.411516846067"));
...
TEST(Decimal128Test, TestAcos) {
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-1.0").acos(), Decimal128("3.14159265359"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.9").acos(), Decimal128("2.69056584179"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.8").acos(), Decimal128("2.4980915448"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.7").acos(), Decimal128("2.34619382341"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.6").acos(), Decimal128("2.21429743559"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.5").acos(), Decimal128("2.09439510239"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.4").acos(), Decimal128("1.98231317286"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.3").acos(), Decimal128("1.87548898081"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.2").acos(), Decimal128("1.77215424759"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.1").acos(), Decimal128("1.67096374796"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.0").acos(), Decimal128("1.57079632679"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.1").acos(), Decimal128("1.47062890563"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.2").acos(), Decimal128("1.369438406"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.3").acos(), Decimal128("1.26610367278"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.4").acos(), Decimal128("1.15927948073"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.5").acos(), Decimal128("1.0471975512"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.6").acos(), Decimal128("0.927295218002"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.7").acos(), Decimal128("0.795398830184"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.8").acos(), Decimal128("0.643501108793"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.9").acos(), Decimal128("0.451026811796"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("1.0").acos(), Decimal128("0.0"));
}

TEST(Decimal128Test, TestAcosh) {
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("1.0").acosh(), Decimal128("0.0"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("1.1").acosh(), Decimal128("0.443568254385"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("1.5").acosh(), Decimal128("0.962423650119"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("2").acosh(), Decimal128("1.31695789692"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("2.5").acosh(), Decimal128("1.56679923697"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("3").acosh(), Decimal128("1.76274717404"));
}

TEST(Decimal128Test, TestAtanh) {
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-1.0").atanh(), Decimal128("-0.785398163397"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.9").atanh(), Decimal128("-0.732815101787"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.8").atanh(), Decimal128("-0.674740942224"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.7").atanh(), Decimal128("-0.610725964389"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.6").atanh(), Decimal128("-0.540419500271"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.5").atanh(), Decimal128("-0.463647609001"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.4").atanh(), Decimal128("-0.380506377112"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.3").atanh(), Decimal128("-0.291456794478"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.2").atanh(), Decimal128("-0.19739555985"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.1").atanh(), Decimal128("-0.0996686524912"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.0").atanh(), Decimal128("0.0"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.1").atanh(), Decimal128("0.0996686524912"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.2").atanh(), Decimal128("0.19739555985"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.3").atanh(), Decimal128("0.291456794478"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.4").atanh(), Decimal128("0.380506377112"));
...
TEST(Decimal128Test, TestCos) {
    ...
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("6.28318530718").cos(), Decimal128("1.0"));
}
...
TEST(Decimal128Test, TestCosh) {
    ...
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("2.35619449019").cosh(), Decimal128("5.32275214952"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("2.61799387799").cosh(), Decimal128("6.89057236498"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("3.14159265359").cosh(), Decimal128("11.5919532755"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("3.66519142919").cosh(), Decimal128("19.5446063168"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("3.92699081699").cosh(), Decimal128("25.3868611924"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("4.18879020479").cosh(), Decimal128("32.97906491"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("4.71238898038").cosh(), Decimal128("55.6633808904"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("5.23598775598").cosh(), Decimal128("93.9599750339"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("5.49778714378").cosh(), Decimal128("122.07757934"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("5.75958653158").cosh(), Decimal128("158.610147472"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("6.28318530718").cosh(), Decimal128("267.746761484"));
}
...
TEST(Decimal128Test, TestSinh) {
    ...
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("2.35619449019").sinh(), Decimal128("5.22797192468"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("2.61799387799").sinh(), Decimal128("6.81762330413"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("3.14159265359").sinh(), Decimal128("11.5487393573"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("3.66519142919").sinh(), Decimal128("19.5190070464"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("3.92699081699").sinh(), Decimal128("25.3671583194"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("4.18879020479").sinh(), Decimal128("32.9639002901"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("4.71238898038").sinh(), Decimal128("55.6543975994"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("5.23598775598").sinh(), Decimal128("93.9546534685"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("5.49778714378").sinh(), Decimal128("122.073483515"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("5.75958653158").sinh(), Decimal128("158.606995057"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("6.28318530718").sinh(), Decimal128("267.744894041"));
}

TEST(Decimal128Test, TestTan) {
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-1.5").tan(), Decimal128("-14.1014199472"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-1.0471975512").tan(), Decimal128("-1.73205080757"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("-0.785398163397").tan(), Decimal128("-1.0"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0").tan(), Decimal128("0.0"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("0.785398163397").tan(), Decimal128("1.0"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("1.0471975512").tan(), Decimal128("1.73205080757"));
    ASSERT_DECIMAL128_APPROX_EQUAL(Decimal128("1.5").tan(), Decimal128("14.1014199472"));
}
...
#undef ASSERT_DECIMAL128_APPROX_EQUAL
