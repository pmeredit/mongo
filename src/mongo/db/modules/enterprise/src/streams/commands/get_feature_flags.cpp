 ...
 */
class GetFeatureFlagsCmd : public TypedCommand<GetFeatureFlagsCmd> {
public:
    using Request = GetFeatureFlagsCommand;
    using Reply = GetFeatureFlagsReply;
    ...
    public:
        ...
        Reply typedRun(OperationContext* opCtx) {
            ...
            return streamManager->testOnlyGetFeatureFlags(requestParams);
        }
...
MONGO_REGISTER_COMMAND(GetFeatureFlagsCmd)
