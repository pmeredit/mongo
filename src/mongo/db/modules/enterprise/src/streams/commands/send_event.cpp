...
/**
 * notifyCheckpointFlushed command implementation.
 */
class SendEventCmd : public TypedCommand<SendEventCmd> {
public:
    using Request = SendEventCommand;
    using Reply = SendEventReply;
...
MONGO_REGISTER_COMMAND(SendEventCmd).requiresFeatureFlag(&mongo::gFeatureFlagStreams).forShard();
