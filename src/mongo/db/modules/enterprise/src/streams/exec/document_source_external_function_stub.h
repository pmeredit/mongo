 ...
 */
class DocumentSourceExternalFunctionStub : public mongo::DocumentSource {
public:
    constexpr static char kStageName[] = "$externalFunction";

    DocumentSourceExternalFunctionStub(const boost::intrusive_ptr<mongo::ExpressionContext>& expCtx,
