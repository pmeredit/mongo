...
/**
 * ExternalFunction is the main functionality that allows users to make requests to a configured
 * destination in response to input data. This only supports AWS Lambda as of today.
 *
 * This class requires a AWS IAM connection and will make a request to that connection and set
 * the response to the user-configured 'as' field before sending the document to it's next
 * destination.
 */
