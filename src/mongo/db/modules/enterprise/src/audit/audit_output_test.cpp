...
TEST_F(AuditMongoTest, basicLogStartupOptionsMongo) {
    ...
    auto expectedOutputMongo =
        ...
        "expireAfterSeconds: 'off' } }, { _id: 'changeStreams', clusterParameterTime: "
        "Timestamp(0, 0), expireAfterSeconds: 3600 }, { _id: "
        "'cwspTestNeedsFeatureFlagBlender', clusterParameterTime: Timestamp(0, 0), intData: 0 "
        "}, { _id: 'cwspTestNeedsLatestFCV', clusterParameterTime: Timestamp(0, 0), intData: 0 "
        "}, { _id: 'fleCompactionOptions', clusterParameterTime: Timestamp(0, 0), "
        "maxCompactionSize: 268435456, maxAnchorCompactionSize: 268435456, "
        "maxESCEntriesPerCompactionDelete: 350000 }, { _id: "
        "'internalQueryCutoffForSampleFromRandomCursor', clusterParameterTime: Timestamp(0, "
        "0), sampleCutoff: 0.05 }, { _id: 'pauseMigrationsDuringMultiUpdates', "
        "clusterParameterTime: Timestamp(0, 0), enabled: false }, { _id: "
        ...
        "clusterParameterTime: Timestamp(0, 0), intData: 16 }, { _id: "
        "'testStrClusterParameter', clusterParameterTime: Timestamp(0, 0), strData: 'off' } ] "
        "}, result: 0 }";
    BSONObj log = getLastNormalized();
    checkPartialLogLine(log, fromjson(expectedOutputMongo));
}
...
TEST_F(AuditOCSFTest, basicLogStartupOptionsOCSF) {
    ...
    auto expectedOutputOCSF =
        ...
        "cluster_parameters: "
        "[ { _id: 'changeStreamOptions', clusterParameterTime: Timestamp(0, 0), "
        "preAndPostImages: { expireAfterSeconds: 'off' } }, { _id: 'changeStreams', "
