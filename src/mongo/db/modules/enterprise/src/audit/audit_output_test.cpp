...
TEST_F(AuditMongoTest, basicLogStartupOptionsMongo) {
    ...
    auto expectedOutputMongo =
        ...
        "clusterParameterTime: Timestamp(0, 0), intData: 0 }, { _id: 'fleCompactionOptions', "
        ...
        "sampleCutoff: 0.05 }, { _id: 'pauseMigrationsDuringMultiUpdates', clusterParameterTime: "
...
TEST_F(AuditOCSFTest, basicLogStartupOptionsOCSF) {
    ...
    auto expectedOutputOCSF =
        ...
        "_id: 'fleCompactionOptions', clusterParameterTime: Timestamp(0, 0), maxCompactionSize: "
        ...
        "Timestamp(0, 0), sampleCutoff: 0.05 }, { _id: 'pauseMigrationsDuringMultiUpdates', "
        ...
        "clusterParameterTime: Timestamp(0, 0), strData: 'off' } ] } }";
    BSONObj log = getLastNormalized();
    checkPartialLogLine(log, fromjson(expectedOutputOCSF));
}
