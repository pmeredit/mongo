...
namespace fts {
    ...
    public:
        ...
        BT_RLP_ContextC* getContext() const { return _context; }
        BT_LanguageID getLanguage() const { return _language; }
    ...
    public:
        std::size_t operator()(BT_LanguageID const& s) const { return s; }
    };
    ...
    public:
         ...
         */
        RlpEnvironment* getRlpEnvironment() { return _rlpEnvironment; }
