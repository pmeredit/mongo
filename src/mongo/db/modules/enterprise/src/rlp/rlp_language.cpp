...
#define MONGO_FTS_RLP_LANGUAGE_LIST(MONGO_FTS_RLP_LANGUAGE_DECL)                               \
    ...
    MONGO_FTS_RLP_LANGUAGE_DECL(                                                               \
        persian, "iranian persian", ("pes"), BT_LANGUAGE_WESTERN_FARSI, kPersianContext)       \
    MONGO_FTS_RLP_LANGUAGE_DECL(urdu, "urdu", ("urd"), BT_LANGUAGE_URDU, kUrduContext)         \
    MONGO_FTS_RLP_LANGUAGE_DECL(zhs,                                                           \
                                "simplified chinese",                                          \
                                ("zhs", "hans"),                                               \
                                BT_LANGUAGE_SIMPLIFIED_CHINESE,                                \
                                kChineseContext)                                               \
    MONGO_FTS_RLP_LANGUAGE_DECL(zht,                                                           \
                                "traditional chinese",                                         \
                                ("zht", "hant"),                                               \
                                BT_LANGUAGE_TRADITIONAL_CHINESE,                               \
                                kChineseContext)
...
#define MONGO_FTS_RLP_EXPERIMENTAL_LANGUAGE_LIST(MONGO_FTS_RLP_LANGUAGE_DECL)                      \
    ...
    MONGO_FTS_RLP_LANGUAGE_DECL(                                                                   \
        por, "portuguese", ("pt"), BT_LANGUAGE_PORTUGUESE, kEuropeanContext)                       \
