...
RlpTokenIterator::RlpIteratorDeleteContext::RlpIteratorDeleteContext(RlpEnvironment* rlpEnvironment)
    : _rlpEnvironment(rlpEnvironment) {}

void RlpTokenIterator::RlpIteratorDeleteContext::operator()(BT_RLP_TokenIteratorC* iterator) const {
    if (iterator) {
