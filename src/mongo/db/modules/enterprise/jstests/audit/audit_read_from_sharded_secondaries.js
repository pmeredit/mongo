...
(function() {
    ...
    var st = new ShardingTest({
        ...
        config: 1,
        other: {
            rsOptions: {auditDestination: 'console'},
            configOptions: {auditDestination: 'console'},
            mongosOptions: {auditDestination: 'console'},
            enableBalancer: false,
            useHostname: true
        }
    });

    // Use a localhost connection to the MongoS to leverage the localhost exception to create an
    // initial
    // user.
