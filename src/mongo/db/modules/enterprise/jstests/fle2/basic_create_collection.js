...
client.createBasicEncryptionCollection("enc_fields_rng_bad_c", encFieldsRangeDoubleMax, 7006601);
...
client.createBasicEncryptionCollection("enc_fields_rng_bad_d", encFieldsRangeDecimalMax, 7006601);
}());
