...
def _get_kafka_start_args(partition_count, broker_config_overrides):
    ...
    kafka_broker_config = {
        ...
        "KAFKA_LISTENER_SECURITY_PROTOCOL_MAP": "PLAINTEXT:PLAINTEXT,PLAINTEXT_INTERNAL:PLAINTEXT,SASL_SSL:SASL_SSL,SSL:SSL",
        "KAFKA_ADVERTISED_LISTENERS": f"PLAINTEXT://localhost:{KAFKA_PORT},PLAINTEXT_INTERNAL://broker:29092,SASL_SSL://localhost:9093,SSL://localhost:9094",
        ...
        "KAFKA_SSL_TRUSTSTORE_CREDENTIALS": "client_truststore_creds",
