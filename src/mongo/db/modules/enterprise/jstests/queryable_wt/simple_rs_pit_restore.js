/**
 * Takes a full backup against a replica set and does a point-in-time restore using queryable.
 *
...
const lastWrite = db.hello().lastWrite.opTime.ts;
...
let conn = MongoRunner.runMongod({
    ...
    queryableBackupMode: "",
    setParameter: {recoverToOplogTimestamp: tojson({timestamp: lastWrite})},
});
assert(conn);
...
// However, we replay the oplog in this test scenario.
