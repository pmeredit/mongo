This directory contains a checkpoint and other relevant info that was taken from a group-sort hopping window pipeline.
...
- jstests-tenant/resume_from_checkpoint_test_spid/1704702863611 : This is the checkpoint state that the test will be resuming from
