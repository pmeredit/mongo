...
function testBoth(useNewCheckpointing, featureFlags = {}) {
    ...
    function smokeTestCorrectnessChangestream() {
        ...
        let test = new TestHelper(input, [], 0, 'changestream', useNewCheckpointing, featureFlags);
        test.run();
        // Wait until the last doc in the input appears in the output collection.
    ...
    function mismatchedCheckpointOperators() {
        ...
        let test = new TestHelper([] /* empty input */,
                                  ...
                                  'changestream',
                                  useNewCheckpointing,
                                  {useExecutionPlanFromCheckpoint: false});
...
// TODO(SERVER-92447): Remove this.
testBoth(true /* useNewCheckpointing */, {useExecutionPlanFromCheckpoint: false});
