...
`{ssn: {$eq: BinData(6, server_tokens)}}`
becomes:
...
`{ssn: {$eq: BinData(6, server_tokens)}}`
becomes:
`{$expr: {$_internalFleEqual: {field: "$ssn", server_tokens: ...}}}`
